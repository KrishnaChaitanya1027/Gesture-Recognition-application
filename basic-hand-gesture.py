...
while(cap.isOpened()):
    ...
    cv2.rectangle(img, (300,300), (100,100), (0,255,0),0) #dimentions of box and color
    crop_img = img[100:300, 100:300]

    # convert to grayscale
    grey = cv2.cvtColor(crop_img, cv2.COLOR_BGR2GRAY)
    hand= cascade.detectMultiScale(grey, 1.59, 1) #

    # applying gaussian blur,filtering procedure(noise eliminate)
    value = (35, 35)
    blurred = cv2.GaussianBlur(grey, value, 0)

    # thresholdin: Otsu's Binarization method (b nd w box) 
    ...
    cv2.imshow('put your gesture on square', img)
